...
@Client.on_message(filters.private & filters.incoming & filters.command(['sidhu']))
...
@Client.on_message(filters.command("sidhu") & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.private & filters.incoming & filters.command(['sid']))
...
@Client.on_message(filters.command("sid") & ~filters.private & ~filters.channel)
